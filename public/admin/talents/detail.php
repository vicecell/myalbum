            ...
            <?php foreach ($photos as $photo): ?>
                <div class="photo-item" data-photo-id="<?= (int) $photo['id'] ?>">
                    ...
                    <div class="photo-item-actions">
                        ...
                        <?php else: ?>
                            <button type="button" class="btn-link crop-btn" data-photo-id="<?= (int) $photo['id'] ?>" data-crop-source="<?= e($photo['imgbb_id'] ? cloudinary_transform_url($photo['imgbb_id'], 1200) : $photo['image_url']) ?>">Crop</button>
                        <?php endif; ?>
